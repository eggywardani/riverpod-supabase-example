...
abstract class $MemoryCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(readValue: _profileId) String profileId,
      @JsonKey(readValue: _username) String username});
}
...
class _$MemoryImpl implements _Memory {
  const _$MemoryImpl(
      ...
      @JsonKey(readValue: _profileId) required this.profileId,
      @JsonKey(readValue: _username) required this.username});
...
abstract class _Memory implements Memory {
  const factory _Memory(
          ...
          @JsonKey(readValue: _profileId) required final String profileId,
          @JsonKey(readValue: _username) required final String username}) =
      _$MemoryImpl;
